...
b_centre03a = rbend('b_centre03',0.2813281018*0.2962,0.0349189639*0.2962,0.0000000000,0.0000000000,-0.3300962629*scalek,'BndMPoleSymplectic4E2Pass',[0 0 0 0],[0 -0.3300962629*scalek 0.0101400673*scalem -0.5218735605*scalen]);
b_centre03b = rbend('b_centre04',0.2813281018*0.4998,0.0349189639*0.4998,0.0000000000,0.0000000000,-0.3300962629*scalek,'BndMPoleSymplectic4E2Pass',[0 0 0 0],[0 -0.3300962629*scalek 0.0101400673*scalem -0.5218735605*scalen]);
b_centre03c = rbend('b_centre05',0.2813281018*0.2040,0.0349189639*0.2040,0.0000000000,0.0000000000,-0.3300962629*scalek,'BndMPoleSymplectic4E2Pass',[0 0 0 0],[0 -0.3300962629*scalek 0.0101400673*scalem -0.5218735605*scalen]);
...
% accordingly.
cav_single = rfcavity('RF' ,0.0,2993700,ringrf,HarmNumber,'CavityPass'); 
cav        = rfcavity('RF' ,0.0,2993700/4,ringrf,HarmNumber,'CavityPass');
